...
if __name__ == "__main__":
    ...
    glass2 = Glass(200, 100)  # экземпляр класса
    print(glass1.capacity_volume, glass1.occupied_volume)
    ...
    glass1.occupied_volume = glass1.occupied_volume + 50
    print(glass1.capacity_volume, glass1.occupied_volume)
    print(glass2.capacity_volume, glass2.occupied_volume)
    print(True if id(glass1) == id(glass2) else False)  # TODO сравнить id объектов (должно вернуть True или False)
